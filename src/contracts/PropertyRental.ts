...
export const PROPERTY_RENTAL_ABI = [
    ...
    "outputs": [
      {
        ...
        "components": [
          ...
          {"name": "propertyType", "type": "string", "internalType": "string"},
          {"name": "dailyRate", "type": "uint256", "internalType": "uint256"},
          {"name": "availableDays", "type": "uint256", "internalType": "uint256"},
  ...
  },
  {
    ...
    "inputs": [],
    "outputs": [
      {"name": "totalProperties", "type": "uint256", "internalType": "uint256"},
      {"name": "totalRentals", "type": "uint256", "internalType": "uint256"},
      {"name": "platformBalance", "type": "uint256", "internalType": "uint256"}
    ],
    "stateMutability": "view"
  },
  {
  ...
  },
  {
    "type": "function",
    "name": "getProperty",
    "inputs": [{"name": "_propertyId", "type": "uint256", "internalType": "uint256"}],
    "outputs": [
      {
        "name": "",
        "type": "tuple",
  ...
  },
  {
    ...
    "inputs": [
      ...
      {"name": "_dailyRate", "type": "uint256", "internalType": "uint256"},
      {"name": "_availableDays", "type": "uint256", "internalType": "uint256"}
    ],
    "outputs": [{"name": "", "type": "uint256", "internalType": "uint256"}],
    "stateMutability": "nonpayable"
  },
  {
    ...
    "name": "rentProperty",
    "inputs": [
      {"name": "_propertyId", "type": "uint256", "internalType": "uint256"},
  ...
  },
  {
    ...
    "inputs": [
      ...
      {"name": "propertyType", "type": "string", "indexed": false, "internalType": "string"},
      {"name": "dailyRate", "type": "uint256", "indexed": false, "internalType": "uint256"}
    ],
    "anonymous": false
  },
  {
    ...
    "inputs": [
      {"name": "propertyId", "type": "uint256", "indexed": true, "internalType": "uint256"},
      {"name": "rentalId", "type": "uint256", "indexed": true, "internalType": "uint256"},
      {"name": "renter", "type": "address", "indexed": true, "internalType": "address"},
      {"name": "rentalDays", "type": "uint256", "indexed": false, "internalType": "uint256"},
